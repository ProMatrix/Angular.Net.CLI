...
var ncp = require("ncp");
var TaskUnEmbed = /** @class */ (function (_super) {
    __extends(TaskUnEmbed, _super);
    function TaskUnEmbed($waitOnCompleted, $visualProject, $synchronous) {
        ...
        _this.unembed(_this.visualProject);
        return _this;
    }
    TaskUnEmbed.prototype.unembed = function (visualProject) {
    };
    return TaskUnEmbed;
}(taskBase_1.TaskBase));
exports.TaskUnEmbed = TaskUnEmbed;
//# sourceMappingURL=taskUnEmbed.js.map