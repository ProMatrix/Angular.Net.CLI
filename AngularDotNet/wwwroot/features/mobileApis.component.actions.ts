...
export class ChangeTabIndex {
  ...
  constructor(public action: string, public name: string, public payload: number, public playback, public delay: number) { }
}
...
export class UpdateTextMessage {
  ...
  constructor(public action: string, public name: string, public payload: string, public playback, public delay: number) { }
}
