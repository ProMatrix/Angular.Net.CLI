...
export class MobileApisComponent {
  ...
  private getSpellcheckingEnabled(): boolean {
    if (!this.ac.mobileApisStateSlice)
      return false;
    return this.ac.mobileApisStateSlice.spellcheckingEnabled;
  }
  // #endregion
