...
const routes: Routes = [
  { path: '', component: SplashComponent },
  {
    ...
    data: { title: 'Technologies', subtitle: 'Quick SPLASH', show: true, helpTemplate: SplashHelpDialog }
  },
  {
    path: 'settings', component: SettingsComponent,
    data: { title: 'Settings', subtitle: 'VERSIONS & SETTINGS', show: true, helpTemplate: SettingsHelpDialog }
  },
  {
    path: 'analytics', component: AnalyticsComponent,
    data: { title: 'Analytics', subtitle: 'Application Analytics', show: true, helpTemplate: AnalyticsHelpDialog }
  },
  {
    path: 'features', component: FeaturesComponent,
    data: { title: 'Features', subtitle: 'More About this Application', show: true, helpTemplate: FeaturesHelpDialog }
  },
  {
    path: 'alreadyReady', component: AlreadyReadyComponent,
    data: { title: 'Already Ready', subtitle: 'Feature Quick Start', show: true, helpTemplate: AlreadyReadyHelpDialog }
  },
  {
    path: 'httpDemo', component: HttpDemoComponent,
    data: { title: 'Http Demo', subtitle: 'Features of the Http Service', show: true, helpTemplate: HttpDemoHelpDialog }
  },
  { path: '**', redirectTo: '/splash', pathMatch: 'full' },
  {
    path: 'restart', redirectTo: '', pathMatch: 'full',
    data: { title: 'Restart', subtitle: 'Restarting the Application...', show: true, helpTemplate: SplashHelpDialog }
  },
];
