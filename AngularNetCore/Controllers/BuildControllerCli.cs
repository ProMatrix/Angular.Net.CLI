// This controller is deprecated because the better build technique uses Node to build
// Save this controller for reference purposes
...
namespace AngularNetCore.Controllers
{
    ...
    public class BuildControllerCli : BaseController
    {
        private readonly IWebHostEnvironment _hostingEnvironment;
        private static List<string> _buildProcessStrings;
        public BuildControllerCli(IWebHostEnvironment hostingEnvironment, IOptions<AppSettings> appSettings, IOptions<ProSettings> proSettings) : base(hostingEnvironment, appSettings, proSettings)
        {
