...
var file_transfer_dialog_component_1 = require("./file.transfer.dialog.component");
...
var HttpDemoComponent = /** @class */ (function () {
    ...
    HttpDemoComponent.prototype.downloadPdfWithProgress = function () {
        ...
        var matDialogRef = this.dialog.open(file_transfer_dialog_component_1.FileTransferDialogComponent, dialogConfig);
    ...
    HttpDemoComponent.prototype.downloadJson = function () {
        var _this = this;
        this.es.getAll(function (library) {
