...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [app_component_1.AppComponent, template_component_1.NewbeeComponent, template_component_1.NewbeeHelpDialogComponent, base_help_dialog_1.BaseHelpDialogComponent],
            entryComponents: [],
